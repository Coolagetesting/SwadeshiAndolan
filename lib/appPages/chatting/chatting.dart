...
class HepBulb extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(bottom: 16.0),
                      ...
                      child: Padding(
                        ...
                        child: SizedBox.fromSize(
                          ...
                          child: Material(
                            ...
                            shape: CircleBorder(),
                            child: Image.asset(
                                'assets/images/chatting/hapblab.png'),
                          ),
                        ),
                      ),
                    ),
                        ...
                        child: Padding(
                          ...
                          child: SizedBox.fromSize(
                            ...
                            child: Material(
                              ...
                              shape: CircleBorder(),
                              child: Image.asset(
                                  'assets/images/chatting/sharechat.png'),
                            ),
                          ),
                        ),
                      ),
...
class JioChat extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(bottom: 16.0),
                      ...
                      child: Padding(
                        ...
                        child: SizedBox.fromSize(
                          ...
                          child: Material(
                            ...
                            shape: CircleBorder(),
                            child: Image.asset(
                                'assets/images/chatting/jiochat.png'),
                          ),
                        ),
                      ),
                    ),
